...
def register_admin_list_customer_routes(app, mysql):
    ...
    # Main page listing all customers.
    ...
    # Old/alternate URL: just forward to the main customers list.
    ...
    # JSON endpoint: fetch a single customer's details by ID
    # (e.g. used by the frontend to populate an edit modal).
